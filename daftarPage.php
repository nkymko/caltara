...
require 'include/regist.inc.php';
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="style/daftarPage.css" />
      ...
      <div class="section-login">
        <div class="wrapper-login">
          ...
          <div class="input">
            ...
            <div class="password">
              <img src="img/icon-password.png" alt="" />
              <input type="password" name="confirmpw" placeholder="Confirm Password" id="myInput" />
              <!-- <input class="eye" type="checkbox" onclick="myFunction()" /> -->
            </div>
            <div class="button">
              <button type="submit" name="register">Daftar</button>
            </form>
              <p>Sudah punya akun? <a href="masukPage.php">Masuk</a></p>
            </div>
          </div>
        </div>
      </div>

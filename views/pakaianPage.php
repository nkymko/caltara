<?php
  ...
  include '../models/pakaianAdat.php';
  session_start();
...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" href="../style/pakaianPage.css" /> -->
...
.wrapper-hero {
  background-image: url(../img/pakaianAdat-hero.png);
  height: 296px;
    ...
    <div class="container">
      ...
      <div class="section-hero">
        <div class="wrapper-hero">
          <h1>Ragam Adat</h1>
          <p>Kain tradisional adalah kain yang berasal dari budaya daerah lokal yang dibuat <br />secara tradisional dan digunakan untuk kepentingan adat dan istiadat.</p>
        </div>
      ...
      <div class="section-content">
        <div class="wrapper-content">
          <h2>Cari sesuatu di <span class="highlight">Pakaian Adat</span></h2>
        ...
        <div class="wrapper-title">
          ...
          <h3>Berbagai macam Pakaian Adat</h3>
          <?php } else { ?>
      ...
      <div class="section-card">
        <div class="wrapper-card">
          <?php if (isset($data)) { ?>
          <?php $i = 1; ?>
          <?php foreach ($pakaianAdat as $row) : ?>
          <a href="detail-pakaianPage.php?id=<?= $row["id_pakaian"]; ?>">
            <div class="card">
              <div class="image">
                <img src="../bajuAdat_img/<?= $row["gambar_pakaian"] ?>" alt="" />
              </div>
              <div class="desc">

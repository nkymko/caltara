...
$detail = getdetail("SELECT * FROM rumah_adat WHERE id = $id")[0];
// $detail = $query[0];
  ...
  <body>
    <div class="container">
      ...
      <div class="section-card">
        <a href="rumahPage.php">
          <img class="back" src="../img/icon-back.png" alt="" />
        </a>
        <div class="wrapper-card">
          <div class="card">
            <div class="left">
              <h1><?= $detail['nama_rumah']?></h1>
              <p>
                <?= $detail['deskripsi']?>
              </p>
            </div>
            <div class="right">
              <img src="../rumahAdat_img/<?= $detail['foto'] ?>" alt="" />
            </div>
          </div>
        </div>
      </div>

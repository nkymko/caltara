...
$detail = getdetail("SELECT * FROM upacara_adat WHERE id = $id")[0];
// $detail = $query[0];
...
<html lang="en">
  <head>
    ...
    <title>Detail Upacara Adat</title>
    <link rel="stylesheet" href="../style/detail-upacaraPage.css" />
  ...
  <body>
    <div class="container">
      ...
      <div class="section-card">
        <a href="upacaraPage.php">
          <img class="back" src="../img/icon-back.png" alt="" />
        </a>
        <div class="wrapper-card">
          <div class="card">
            <div class="left">
              <h1><?= $detail['nama_upacara'] ?></h1>
              <p>
                <?= $detail['deskripsi'] ?>
              </p>
            </div>
            <div class="right">
              <img src="../upacara_img/<?= $detail['gambar'] ?>" alt="" />
            </div>
          </div>
        </div>
      </div>

...
<html lang="en">
  <head>
    ...
    <title>Teater</title>
    <link rel="stylesheet" href="../style/teaterPage.css" />
  </head>
  <body>
    <div class="container">
      ...
      <div class="section-content">
        <div class="wrapper-content">
          <div class="left">
            <h2>Cari sesuatu di <span class="highlight">Seni Teater</span></h2>
        ...
        <?php if (!isset($_POST["search"])) { ?>
          <h3>Berbagai macam Seni Teater</h3>
          <?php } else { ?>
      ...
      <div class="section-card">
        ...
        <?php if (isset($data)) { ?>
        <?php $i = 1; ?>
        <?php foreach ($seniTeater as $row) : ?>
          <a href="detail-teaterPage.php?id=<?= $row['id'] ?>">
            <div class="card">
              <div class="image">
                <img src="../teater_img/<?= $row['gambar'] ?>" alt="" />
              </div>
              <div class="desc">
                <h3><?= $row['nama_teater'] ?></h3>
                <p><?= $row['preview'] ?></p>
              </div>
            </div>
          </a>

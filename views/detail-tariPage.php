...
$detail = getdetail("SELECT * FROM seni_tari WHERE id = $id")[0];
...
<html lang="en">
  <head>
    ...
    <title>Detail Seni Tari</title>
    <link rel="stylesheet" href="../style/detail-tariPage.css" />
  </head>
  <body>
    <div class="container">
      ...
      <div class="section-card">
        ...
        <div class="wrapper-card">
          <div class="card">
            ...
            <div class="right">
              <img src="../seniTari_img/<?= $detail["gambar"] ?>" alt="" />
            </div>
          </div>
        </div>
      </div>

...
$detail = getdetail("SELECT * FROM seni_teater WHERE id = $id")[0];
...
<html lang="en">
  <head>
    ...
    <title>Detail Seni Teater</title>
    <link rel="stylesheet" href="../style/detail-teaterPage.css" />
  </head>
  <body>
    <div class="container">
      ...
      <div class="section-card">
        <a href="teaterPage.php">
          <img class="back" src="../img/icon-back.png" alt="" />
        </a>
        <div class="wrapper-card">
          <div class="card">
            <div class="left">
              <h1><?= $detail['nama_teater'] ?></h1>
              <p>
                <?= $detail['deskripi'] ?>
              </p>
            </div>
            <div class="right">
              <img src="../teater_img/<?= $detail['gambar'] ?>" alt="" />
            </div>
          </div>
        </div>
      </div>
